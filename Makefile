...
g1:
	python3 gen_huff.py templates/ecmul/ecmul_dbl_and_add.huff.template build/src/ecmul/g1mul_dbl_and_add.huff G1
	bash -c "./huff-rs/target/release/huffc --artifacts --bytecode build/src/ecmul/g1mul_dbl_and_add.huff > build/artifacts/ecmul/g1mul_dbl_and_add.hex"
g2:
